               ...
               <div class="col-md-4">
                   <div class="full">
                      ...
                      <div class="information_f">
                        ...
                        <p><strong>TELEPHONE:</strong> +63 123 456 7890</p>
                        <p><strong>EMAIL:</strong> techtradephmarket@gmail.com</p>
                      </div>
                   </div>
               </div>
               <div class="col-md-8">
                  ...
                  <div class="col-md-5">
                     <div class="widget_menu">
                        <h3>Newsletter</h3>
                        <div class="information_f">
                          <p>Subscribe by our newsletter and get update & promotion.</p>
                        </div>
                        <div class="form_sub">
                           <form>
                              <fieldset>
